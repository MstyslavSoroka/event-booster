var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},o={},d=e.parcelRequire94c2;null==d&&((d=function(e){if(e in n)return n[e].exports;if(e in o){var d=o[e];delete o[e];var t={id:e,exports:{}};return n[e]=t,d.call(t.exports,t,t.exports),t.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,n){o[e]=n},e.parcelRequire94c2=d),(0,d.register)("kyEFX",function(e,n){Object.defineProperty(e.exports,"register",{get:function(){return o},set:function(e){return o=e},enumerable:!0,configurable:!0});var o,d=new Map;o=function(e,n){for(var o=0;o<n.length-1;o+=2)d.set(n[o],{baseUrl:e,path:n[o+1]})}}),d("kyEFX").register(new URL("",import.meta.url).toString(),JSON.parse('["5ZPII","index.a8558d6f.js","6RkRa","symbol-defs.c5b0f01c.svg"]'));var t={};async function i(e){let n=document.getElementById("postsContainer");n.innerHTML="",e.forEach(e=>{var o,d,i,l,a,s,r,c;let v=(null===(d=e.images)||void 0===d?void 0:null===(o=d[0])||void 0===o?void 0:o.url)||"https://via.placeholder.com/300",u=e.name||"Невідома подія",m=(null===(l=e.dates)||void 0===l?void 0:null===(i=l.start)||void 0===i?void 0:i.localDate)||"Невідома дата",p=(null===(r=e._embedded)||void 0===r?void 0:null===(s=r.venues)||void 0===s?void 0:null===(a=s[0])||void 0===a?void 0:a.name)||"Невідоме місце",f=e.id,g=document.createElement("div");g.classList.add("event-card"),g.dataset.id=`${f}`,g.innerHTML=`
    ...
    `,n.appendChild(g)})}async function l(e){var n;let o=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?size=20&apikey=${e}`);return(null===(n=(await o.json())._embedded)||void 0===n?void 0:n.events)||[]}async function a(){async function e(){try{var e;let n=await fetch("https://app.ticketmaster.com/discovery/v2/events.json?apikey=Z0jpFmdgR3VO2MAgupFCQ1c6yNovbVdi"),o=await n.json();return null===(e=o._embedded)||void 0===e?void 0:e.events}catch(e){console.error("Error fetching event data:",e)}}let n=await e();function o(){document.querySelector(".overlay").classList.remove("overlay-visible"),document.body.classList.remove("no-scroll"),a.innerHTML=""}document.querySelectorAll(".event-card").forEach(e=>{e.addEventListener("click",e=>{var d,t,i,l,a,s,r,c,v,u,m,p,f,g,h,y;let b=e.currentTarget.dataset.id,E=document.querySelector(".modal"),w=n.find(e=>e.id===b),k=null==w?void 0:null===(d=w.images.find(e=>205===e.width))||void 0===d?void 0:d.url;null==w||null===(t=w.images.find(e=>205===e.width))||void 0===t||t.url,E.innerHTML=`
      ...
      <div class="modal-content-wrap">
        ...
        <p>
          ${(null==w?void 0:null===(l=w.dates)||void 0===l?void 0:null===(i=l.start)||void 0===i?void 0:i.localDate)||"Unknown date"} <br />
      ...
      `,E.querySelector(".close-modal").addEventListener("click",o),function(){let e=document.querySelector(".overlay");document.body.classList.add("no-scroll"),e.classList.add("overlay-visible")}(),console.log(`Card ID: ${b}`)})}),document.addEventListener("keydown",e=>{"Escape"===e.key&&o()})}t=new URL("symbol-defs.c5b0f01c.svg",import.meta.url).toString();const s="Z0jpFmdgR3VO2MAgupFCQ1c6yNovbVdi";async function r(e){let n=await l(s),o=Math.ceil(n.length/5);i(n.slice((e-1)*5,5*e)),function(e,n,o){let d=document.getElementById("pags");d.innerHTML="";for(let t=1;t<=e;t++){let e=document.createElement("span");e.innerText=t,e.classList.add("page"),t===n&&e.classList.add("active"),e.onclick=()=>{o(n=t)},d.appendChild(e)}}(o,e,r)}r(1),l(s).then(e=>{i(e),a()});
//# sourceMappingURL=index.a8558d6f.js.map
